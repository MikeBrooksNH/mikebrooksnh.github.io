        ...
        <div class="container-fluid text-center">    
            <div class="row content">
                <div class="col-sm-8 text-left"> 
                    ...
                    <h4>Insert Application</h4>
                    <hr><br>
                    <form name="emp"  action="confirminsert.jsp" method="POST">
                        ...
                        <table border="1">
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><input name="appname" type="text"><br>
                                  </td>
                                </tr>
                                <tr>
                                  <td >Abreviation</td>
                                  <td ><input name="abreviation" type="text"><br>
                                  </td>
                                </tr>
                                <tr>
                                  <td>Line of Business</td>
                                  <td><input name="lob" type="text"><br>
                                  </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <input type="submit" <button type="button" class="btn btn-primary" value="Add Application" />
                    </form>
                </div>
            </div>
