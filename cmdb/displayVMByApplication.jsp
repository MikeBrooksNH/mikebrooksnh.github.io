        ...
        <div class="container-fluid text-center">    
            <div class="row content">
                <div class="col-sm-8 text-left"> 
                    ...
                    %>
                    Requested search Application = <%=name%><br>
                    ...
                    <table   class="table table-condensed" >  
                        ...
                        <%
                            try {
                                ...
                                //ResultSet apprs = stmt.executeQuery("select id from application where (name = '" + name + "')");
                                %>
                                
                                 
                                <%
                                    ResultSet rs = stmt.executeQuery("select * from vm where (appid = " 
                                        + "(select id from applications where (name = '" + name
                                        + "')))");        
