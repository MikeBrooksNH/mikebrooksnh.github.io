        ...
        <div class="container-fluid text-center">    
            <div class="row content">
                <div class="col-sm-8 text-left"> 
                    ...
                    <form name="emp" onload="clear()" action="displayVMByApplication.jsp" method="POST">
                        <table>
                            <tbody>
                                <tr>
                                    <td>Please Enter Application to search for Servers</td>
                                    <td><input name="name" type="text"></td>
                                </tr>
                            </tbody>
                        </table>
                        <input type="reset"  <button type="button" class="btn btn-primary" value="Reset Values" name="Reset" />
                        <input type="submit" <button type="button" class="btn btn-primary" value="Get VMs" />
                    </form>
                </div>
            </div>
